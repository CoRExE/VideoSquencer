...
class HTMLReportWriter:
    def __init__(self, folder_path, report_name, metadata=None):
        """
        Initialize the class with the given folder path, report name, and optional metadata.

        Parameters:
            folder_path (str): The path to the folder.
            report_name (str): The name of the report.
            metadata (dict, optional): Additional metadata to be stored, defaults to None.
        """
    ...
    def write_report(self):
        """
        Write a report by rendering the index page template with the report name and content generated by calling generate_cards().
        Save the rendered index page to a file in the temporary directory and move the files to the specified folder path. Finally, remove the temporary directory.
        """
    ...
    def generate_cards(self):
        """
        A function that generates cards using a template from a file for each folder in a given directory.
        """
        result = ""
    ...
    def generate_card(self, component, folder):
        """
        Generate a card for a given component in the specified folder.

        Parameters:
            component: The component to be rendered.
            folder: The folder in which the component will be rendered.

        Returns:
            The rendered component card.
        """
    ...
    def generate_lists(self, folder):
        """
        Generate lists based on the provided folder and its contents.

        :param folder: The directory for which to generate the lists
        :type folder: str
        """
        folders = []
    ...
    def generate_list(self, folder, folders, pos):
        """
        Generates a list of images for a given folder and renders an HTML file with the list.

        Parameters:
            folder (str): The name of the folder containing the images.
            folders (list): List of folder names.
            pos (int): The position of the current folder in the list.
